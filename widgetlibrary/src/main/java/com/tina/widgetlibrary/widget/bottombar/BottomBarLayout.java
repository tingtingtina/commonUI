 ...
 * Date: 2018/8/25
 * Description：底部菜单栏
 * Reference：https://blog.csdn.net/Chay_Chan/article/details/73715607
 */
public class BottomBarLayout extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    private boolean mSmoothScroll; //若设置viewPager 可设置
    ...
    public BottomBarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.BottomBarLayout);
        mSmoothScroll = a.getBoolean(R.styleable.BottomBarLayout_bb_smoothScroll, false);
        a.recycle();
    }
    ...
    private void init() {
        ...
        for (int i = 0; i < mChildCount; i++) {
            if (getChildAt(i) instanceof BottomBarItem) {
                ...
                //设置点击监听
                bottomBarItem.setOnClickListener(new OnItemClickListener(i));
            } else {
